...
You might also check [Laravel version](https://github.com/chris-e-hanson/laravel-example) of this app.
...
```
git clone https://github.com/chris-e-hanson/ruby-example
cd ruby-example
```
